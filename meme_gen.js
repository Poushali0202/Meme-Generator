let topTextInput, bottomTextInput, topTextSizeInput, bottomTextSizeInput, imageInput, generateBtn, canvas, downloadBtn, ctx;
...
function init () {
    ...
    // Default/Demo text
    topTextInput.value = 'Headline';
    bottomTextInput.value = 'Sub\nHeadline';
